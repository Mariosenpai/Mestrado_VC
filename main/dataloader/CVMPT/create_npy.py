...
from main.config import arquivos_ignorados_CVMPT
...
if __name__ == '__main__':
    ...
    print(data["mel_noise"].shape)
    print(data["mel"].shape)
    print(data["mel_noise"])