...
class GenerativeNetwork(nn.Module):
    ...
    def __init__(self, device='cpu'):
        ...
        self.hidden_size = 4
        self.patch_size = 16
        configuration = ViTConfig(num_attention_heads=4, num_hidden_layers=8, hidden_size=self.hidden_size,
                                  patch_size=self.patch_size, num_channels=1, image_size=image_size)
