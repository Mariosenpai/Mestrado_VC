...
from main.arquitetura.auto_encoder.modelo.residual_block import ResidualBlockAuto
from main.config import image_size


class GenerativeNetworkAuto(nn.Module):

    def __init__(self, device='cpu'):
        super(GenerativeNetworkAuto, self).__init__()
        self.device = device
